            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{route('admin.login.send')}}">
                                @csrf
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    <div class="col-sm-7 mt-3">
                                        <a href="{{ route('admin.recover') }}" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                    </div>
